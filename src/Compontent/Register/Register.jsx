                ...
                <div className="row">
                    ...
                    <div className="col-md-12 bg-register-image  col-sm-12 col-xxl-7 col-xl-7 col-lg-7">
                        ...
                        <div className='row'>
                            <div className='col-md-3 mt-5'>
                                ...
                                <Link className={`${style.acon} ms-2 text-primary text-decoration-none `} to="/login">Login here! </Link>
                            </div>
                    ...
                    <div className="col-md-12 bg-register-image  col-sm-12 col-xxl-4 col-xl-4 col-lg-4  ">
                        ...
                        <form onSubmit={submitRegisterForm}>
                            ...
                            <p className="text-white small text-center text-white mt-3">
                                <input value="register" name="gender" type="checkbox" className=' me-2' />
                                By creating an account you agree to the
                                <p > <a className=" text-primary mx-1" href="https://policies.google.com/terms">terms of use</a>
                                    and our
                                    <a className="text-primary mx-1" href="https://policies.google.com/privacy" > Privacy Policy</a>
                                </p>
                            </p>
                            <button type='submit' className={`${style.btn} btn btn-outline-primary text-white  w-100 mb-3 py-2 `} >{isLoading === true ? <i className=' fas fa-spinner fa-spin'></i> : 'Register'}</button>
                            ...
                            <div className=' row mt-4'>
                                ...
                                <div className=' col-4 '>
                                    <button className=' btn btn-outline-primary  rounded-3 ms-5'> <i className=' fab mx-1 fa-google icon '></i></button>
                                </div>
                                <div className=' col-3'>
                                    <button className=' btn btn-outline-primary rounded-3 '><i className=' fab mx-1 fa-apple icon1'></i></button>
                                </div>
                                <div className='col-3 '>
                                    <button className=' btn btn-outline-primary rounded-3 '> <i className=' fab mx-1 fa-facebook icon2'></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
