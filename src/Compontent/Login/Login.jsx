                ...
                <div className="row">
                    <div className="col-md-12 bg-register-image  col-sm-12 col-xxl-7 col-xl-7 col-lg-7">
                        ...
                        <div className='row'>
                            <div className='col-md-3 mt-5'>
                                ...
                                <Link className={`${style.acon} ms-2 text-primary text-decoration-none `} to="/register">Register here! </Link>
                            </div>
                    ...
                    <div className="col-md-12 bg-register-image  col-sm-12 col-xxl-4 col-xl-4 col-lg-4">
                        ...
                        <form onSubmit={submitloginForm}>
                            ...
                            <p className=' text-muted  mt-3 left'>Recover Password ?</p>
                            <button type='submit' className={`${style.btn} btn btn-outline-primary text-white  w-100 mb-3 py-2 `} >{isLoading === true ? <i className=' fas fa-spinner fa-spin'></i> : 'Login'}</button>
                            ...
                            <div className=' row mt-4'>
                                ...
                                <div className=' col-4'>
                                    <button className=' btn btn-outline-primary rounded-3 ms-5'> <i className=' fab mx-1 fa-google  '></i></button>
                                </div>
                                <div className=' col-3'>
                                    <button className=' btn btn-outline-primary rounded-3  '><i className=' fab mx-1 fa-apple '></i></button>
                                </div>
                                <div className=' col-3'>
                                    <button className=' rounded-3  btn btn-outline-primary '> <i className=' fab mx-1 fa-facebook '></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
