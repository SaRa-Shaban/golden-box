    ...
    return (
        <>
            ...
            <div className={`${style.contact} py-5`}>
                ...
                <h1 className='b text-center pt-5 mb-5'>Contact Us</h1>
                        ...
                        <div className="h-100">
                            <form action="" className='' >
                                ...
                                <div className="my-3">
                                    ...
                                    <textarea name="" id="message" cols="30" rows="6" className={`form-control ${style.customFormControl}`} placeholder='Message' ></textarea>
                                </div>
